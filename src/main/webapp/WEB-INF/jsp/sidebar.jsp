	...
	<ul class="sidebar-nav" id="sidebar-nav">
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="member-section" class="nav-content collapse">
				...
				<li><a href="financialYear"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">FINANCIAL YEAR</span>
				</a></li>

				<li><a href="createBranch"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">CREATE BRANCH</span>
				</a></li>

				<li><a href="bankModule"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">BANK MODULE</span>
				</a></li>

				<li><a href="relativeModule"> <i class="bi bi-circle"></i>
				...
				<li><a href="codeModule"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">CODE MODULE</span>
				</a></li>

				<li><a href="executivePromoter"> <i class="bi bi-circle"></i>
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="customer-management" class="nav-content collapse">
				...
				<li><a href="customerSummary"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">CUSTOMER
							SUMMARY</span>
				</a></li>

				<li><a href="customerReport"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">CUSTOMER
							REPORT</span>
				</a></li>

				<li><a href="searchCustomer"> <i class="bi bi-circle"></i>
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="member-share" class="nav-content collapse">
				...
				<li><a href="generateShareCertificate"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">GENERATE SHARE
							CERTIFICATE</span>
				</a></li>

				<li><a href="regenerateDNO"> <i class="bi bi-circle"></i> <span
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="account-section" class="nav-content collapse">
				<li><a href="ledgerAccountMaster"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">LEDGER
							ACCOUNT MASTER</span>
				</a></li>

				<li><a href="outgoingPaymentEntry"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">OUTGOING
							PAYMENT ENTRY</span>
				</a></li>

				<li><a href="incomingReceiptEntry"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">INCOMING
							RECEIPT ENTRY</span>
				</a></li>

				<li><a href="bankCashTransferEntry"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">BANK/CASH
							TRANSFER ENTRY</span>
				</a></li>

				<li><a href="manualJournalEntry"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">MANUAL
							JOURNAL ENTRY</span>
				</a></li>

				<li><a href="incentivePayment"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">INCENTIVE
							PAYMENT</span>
				</a></li>

				<li><a href="misInterestPaymentAccountSection"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">MIS INTEREST
							PAYMENT</span>
				</a></li>

				<li><a href="chequeClearingProcessing"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">CHEQUE CLEARANCE
							PROCESSING</span>
				</a></li>

				<li><a href="mandateDepositToBank"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">MANDATE
							DEPOSIT TO BANK</span>
				</a></li>

				<li><a href="bankStatement"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">BANK STATEMENT</span>
				</a></li>

				<li><a href="cashBook"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">CASH BOOK</span>
				</a></li>

				<li><a href="fundstransferRegister"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">FUNDS TRANSFER
							REGISTER</span>
				</a></li>

				<li><a href="dailyTransactionBook"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">DAILY
							TRANSACTION BOOK</span>
				</a></li>

				<li><a href="ledgerSummaryReport"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">LEDGER
							SUMMARY REPORT</span>
				</a></li>

				<li><a href="journalEntryReport"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">JOURNAL
							ENTRY REPORT</span>
				</a></li>

				<li><a href="trailBalanceReport"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">TRIAL
							BALANCE REPORT</span>
				</a></li>

				<li><a href="pLStatement"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">P&L STATEMENT</span>
				</a></li>

				<li><a href="balanceSheet"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">BALANCE SHEET</span>
				</a></li>

				<li><a href="interbranchCashTransfer"> <i
						class="bi bi-circle"></i> <span
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="saving-account" class="nav-content collapse">
				<li><a href="savingsSchemaCatalog"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">SAVINGS
							SCHEME CATALOG</span>
				</a></li>

				<li><a href="createSavingsAccount"> <i class="bi bi-circle"></i>
            ...
            <a href="createCurrentAccount">
              ...
              <span style="font-family: 'Poppins', sans-serif">Create Current Account</span>
				...
				<li><a href="savingsAccountActivity"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">SAVINGS ACCOUNT
							ACTIVITY</span>
				</a></li>

				<li><a href="savingsAccountFundTransfer"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">SAVINGS ACCOUNT
							FUND TRANSFER</span>
				</a></li>

				<li><a href="savingAccountInterestTransfer"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">SAVINGS ACCOUNT
							INTEREST TRANSFER</span>
				</a></li>

				<li><a href="savingsRecordBook"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">SAVINGS
							RECORD BOOK</span>
				</a></li>
            ...
            <a href="currentAccountRecordBook">
              ...
              <span style="font-family: 'Poppins', sans-serif">Current Account Record Book</span>
				...
				<li><a href="savingsAccountCloser"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">SAVING
							ACCOUNT CLOSER</span>
				</a></li>

				<li><a href="savingsAccountInquiry"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">SAVINGS ACCOUNT
							INQUIRY</span>
				</a></li>

				<li><a href="smsServiceFee"> <i class="bi bi-circle"></i> <span
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="investment-section" class="nav-content collapse">
				...
				<li><a href="investmentDataSearch"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">SEARCH
							POLICY </span>
				</a></li>
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="loan-section" class="nav-content collapse">
				...
				<li><a href="generateNOCCertificateLoanManagement"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">GENERATE NOC
							CERTIFICATE</span>
				</a></li>

				<li><a href="searchLoanAccounts"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">SEARCH
							LOAN ACCOUNTS</span>
				</a></li>
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="Goldloan-section" class="nav-content collapse">
				...
				<li><a href="goldDirectory"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">GOLD DIRECTORY</span>
				</a></li>

				<li><a href="applyforGold"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">APPLY FOR GOLD</span>
				</a></li>

				<li><a href="goldLoanApproval"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">GOLD LOAN
							APPROVAL</span>
				</a></li>

				<li><a href="goldLoanPayment"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">GOLD LOAN
							PAYMENT</span>
				</a></li>

				<li><a href="emiInstallmentPayment"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">EMI INSTALLMENT
							PAYMENT</span>
				</a></li>

				<li><a href="goldLoanDocument"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">GOLD LOAN
							DOCUMENT</span>
				</a></li>
				...
				<li><a href="goldLoanStatement"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">GOLD LOAN
							STATEMENT</span>
				</a></li>


				<li><a href="goldLoanClosure"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">GOLD LOAN
							CLOSURE</span>
				</a></li>
				...
				<li><a href="printNOC"> <i class="bi bi-circle"></i> <span
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="group-loan-section" class="nav-content collapse">
				<li><a href="createLendingGroup"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">CREATE
							LENDING GROUP</span>
				</a></li>

				<li><a href="groupDirectory"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">GROUP
							DIRECTORY</span>
				</a></li>

				<li><a href="applyForGroupLoan"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">APPLY FOR
							GROUP LOAN</span>
				</a></li>

				<li><a href="loanApproval"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">LOAN APPROVAL</span>
				</a></li>
				...
				<li><a href="installmentRepayment"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">INSTALLMENT
							RE-PAYMENT</span>
				</a></li>

				<li><a href="statementOfAccount"> <i class="bi bi-circle"></i>
				...
				<li><a href="completedLoansRecord"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">COMPLETED
							LOAN RECORD</span>
				</a></li>

				<li><a href="findLoanRecord"> <i class="bi bi-circle"></i>
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="approval-section" class="nav-content collapse">
				<li><a href="approveNewCustomer"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">APPROVE
							CUSTOMER</span>
				</a></li>

				<li><a href="approveShare"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">APPROVE SHARE
							TRANSACTIONS</span>
				</a></li>

				<li><a href="approveFinance"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">APPROVE
							FINANCE ONBOARDING</span>
				</a></li>

				<li><a href="approvePolicy"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">APPROVE POLICY</span>
				</a></li>

				<li><a href="approveRD"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">APPROVE RD</span>
				</a></li>

				<li><a href="approveFD"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">APPROVE FD</span>
				</a></li>

				<li><a href="approveDD"> <i class="bi bi-circle"></i> <span
				...
				<li><a href="approveSaving"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">APPROVE SAVING
							TRANSACTIONS</span>
				</a></li>

				<li><a href="approveSavingAccount"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">APPROVE
							SAVINGS ACCOUNT TRANSFERS</span>
				</a></li>

				<li><a href="approveRegularEMI"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">APPROVE
							REGULAR EMI PAYMENTS</span>
				</a></li>

				<li><a href="approveIrregularEMI"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">APPROVE
							IRREGULAR EMI PAYMENTS</span>
				</a></li>

				<li><a href="approveManualPayment"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">APPROVE
							MANUAL PAYMENT ENTRIES</span>
				</a></li>

				<li><a href="approveMaturityApp"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">APPROVE
...
<!-- 				<li><a href="deleteMaturityApp"> <i class="bi bi-circle"></i>
				...
				<li><a href="approveInterBranchCashTransfer"> <i
						class="bi bi-circle"></i> <span
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="rectification-section" class="nav-content collapse">
				<li><a href="customerDataUpdate"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">CUSTOMER
							DATA UPDATE</span>
				</a></li>

				<li><a href="shareholdingAdjustment"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">SHAREHOLDING
							ADJUSTMENT</span>
				</a></li>

				<li><a href="financialEntryCorrection"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">FINANCIAL ENTRY
							CORRECTION</span>
				</a></li>

				<li><a href="policyDetailsUpdate"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">POLICY
							DETAILS UPDATE</span>
				</a></li>

				<li><a href="renewalDataCorrection"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">RENEWAL DATA
							CORRECTION</span>
				</a></li>

				<li><a href="dailyRenewalUpdate"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">DAILY
							RENEWAL UPDATE</span>
				</a></li>

				<li><a href="flexibleTransactionRemoval"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">FLEXIBLE
							TRANSACTION REMOVAL</span>
				</a></li>

				<li><a href="savingsAccountCorrection"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">SAVINGS ACCOUNT
							CORRECTION</span>
				</a></li>

				<li><a href="savingsTransactionRemoval"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">SAVINGS
							TRANSACTION REMOVAL</span>
				</a></li>

				<li><a href="loanAccountCorrection"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">LOAN ACCOUNT
							CORRECTION</span>
				</a></li>

				<li><a href="groupLoanDataUpdate"> <i class="bi bi-circle"></i>
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="maturity-section" class="nav-content collapse">
				<li><a href="maturitySchemeMaster"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">MATURITY
							SCHEME MASTER</span>
				</a></li>

				<li><a href="applyForMaturity"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">APPLY FOR
							MATURITY</span>
				</a></li>

				<li><a href="maturityApplicationStatus"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">MATURITY
							APPLICATION STATUS</span>
				</a></li>

				<li><a href="fullMaturityPayment"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">FULL
							MATURITY PAYMENT</span>
				</a></li>

				<li><a href="fullPaymentStatus"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">FULL
							PAYMENT STATUS</span>
				</a></li>


				<li><a href="partialMaturityPayment"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">PARTIAL MATURITY
							PAYMENT</span>
				</a></li>

				<li><a href="partialPaymentStatusMaturityApplication"> <i
						class="bi bi-circle"></i> <span
				...
				<li><a href="approvedStatusMaturityManagement"> <i
						class="bi bi-circle"></i> <span
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="incentive-section" class="nav-content collapse">
				<li><a href="incentiveSchemeMaster"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">INCENTIVE SCHEME
							MASTER</span>
				</a></li>

				<li><a href="generateIncentivePayments"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">GENERATE
							INCENTIVE PAYMENTS</span>
				</a></li>

				<li><a href="incentivePaymentDetails"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">INCENTIVE
							PAYMENT DETAILS</span>
				</a></li>

				<li><a href="incentiveSummaryReport"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">INCENTIVE
							SUMMARY REPORT</span>
				</a></li>
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="collector-advisor" class="nav-content collapse">
				<li><a href="addFinancialConsultant"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">ADD FINANCIAL
							CONSULTANT</span>
				</a></li>

				<li><a href="financialConsultantHierarchy"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">FINANCIAL
							CONSULTANT HIERARCHY</span>
				</a></li>

				<li><a href="consultantDownlineView"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">CONSULTANT
							DOWNLINE VIEW</span>
				</a></li>

				<li><a href="consultantPromotionManagement"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">CONSULTANT
							PROMOTION MANAGEMENT</span>
				</a></li>

				<li><a href="consultantIDCardGenerator"> <i
						class="bi bi-circle"></i> <span
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="employee-section" class="nav-content collapse">
				<li><a href="manageDesignations"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">MANAGE
							DESIGNATIONS</span>
				</a></li>

				<li><a href="manageDepartments"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">MANAGE
							DEPARTMENTS</span>
				</a></li>

				<li><a href="addTeamMember"> <i class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">ADD TEAM MEMBER</span>
				</a></li>

				<li><a href="generateTeamMemberIDCard"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">GENERATE TEAM
							MEMBER ID CARD</span>
				</a></li>

				<li><a href="searchTeamMember"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">SEARCH
							TEAM MEMBER</span>
				</a></li>
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="report-section" class="nav-content collapse">
				<li><a href="investmentTransactionReport"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">INVESTMENT
				...
				<li><a href="incentivePaymentSummary"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">INCENTIVE
							PAYMENT SUMMARY</span>
				</a></li>

				<li><a href="recurringInstallmentDueReport"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">RECURRING
				...
				<li><a href="upcomingEMIDueReport"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">UPCOMING
							EMI DUE REPORT</span>
				</a></li>

				<li><a href="overdueRepaymentAnalysis"> <i
						class="bi bi-circle"></i> <span
						style="font-family: 'Poppins', sans-serif">OVERDUE
							REPAYMENT ANALYSIS</span>
				</a></li>

				<li><a href="loanInstallmentPendingReport"> <i
						class="bi bi-circle"></i> <span
				...
				<li><a href="maturityStatusReport"> <i class="bi bi-circle"></i>
						<span style="font-family: 'Poppins', sans-serif">MATURITY
							STATUS REPORT</span>
				</a></li>
